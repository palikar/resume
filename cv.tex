...
\begin{figure}[!htb]
  \begin{minipage}{.5\textwidth}
    \begin{flushleft}
      \vspace{1.3cm}
      \small \textbf{\huge Stanislav Arnaudov} \\  \href{mailto:stanislav.arn@gmail.com}{\color{blue}\underline{stanislav.arn@gmail.com}} $\vert$
      LinkedIn: \href{https://www.linkedin.com/in/stanislav-arnaudov-37b475164/}{\color{blue}\underline{Arnaudov}} $\vert$\\
      Github: \href{https://github.com/palikar}{\color{blue}\underline{Arnaudov}} $\vert$ Website: \href{https://www.stanislavts.com}{\color{blue}\underline{stanislavts.com}}\\
...
\resumeSubheading
{Master of Science in Informatics [Not finished]} {Sep 2018 - Sep 2015 - Sep 2020}
{Karlsruhe Institute of Technology}{Karlsruhe, Germany}
\resumeItemListStart
\resumeItem{Relevant Coursework}{Natural language processing, Image processing, Computer Vision, Machine Learning, Software Engineering, Visualization}
\resumeItemListEnd
...
\resumeSubheading{Primary Focus}{}{\vspace{-5pt}}{}
Computer graphics, Real-time 3D rendering, Game development \\
Performance oriented software, Low-level Optimization

\resumeSubheading{Programming Languages}{}{\vspace{-5pt}}{}
C++, C\#, Java, Python, JavaScript\textbackslash CSS\textbackslash HTML, Go, SQL, Emacs-Lisp
\resumeSubheading{Technologies}{}{\vspace{-5pt}}{}
DirectX11/12, Vulkan, Metal, PS4/PS5, XBox, Nintendo Switch, OpenGL\\
Unreal Engine 4/5, Unity\\
Frontend (AngularJS, VueJS), Backend (NodeJS, Express, Flask)\\
Linux, Git, CMake, MSBuild, Visual Studio
\resumeSubHeadingListEnd
\vspace{7pt}
...
\resumeSubheading
{Advanced Graphics\textbackslash Rendering Engineer}{Nov 2020 - 2023}
{\href{https://coherent-labs.com/}{\color{blue}\underline{Coherent Labs}}}{Sofia, Bulgaria}
\resumeItemListStart
\resumeItem{Rendering}
{Responsible for devloping and maintaining the core rendering library of the company's product}
\resumeItem{R\&D}
{Responsible for reasearching and devloping new features}
\resumeItem{Integration}
{Responsible for integrating new features with Unreal Engine 4 and Unity}
\resumeItemListEnd

\resumeSubheading
{Software Engineer\textbackslash Research Assistant}{Sep 2017 - Sep 2020}
{\href{https://www.iosb.fraunhofer.de/}{\color{blue}\underline{Fraunhofer IOSB}}}{Karlsruhe Germany}
\resumeItemListStart
...
{\href{https://www.kit.edu/}{\color{blue}\underline{Karlsruher Institute of Technology}}}{Karlsruhe Germany}
\resumeItemListStart
...
\item Part of a team that ranked \textbf{second} in the (\href{https://www.meetup.com/Darmstadt-InnovationM-Round-Table/events/262603767/}{\color{blue}\underline{Code-2-Cloud Hackathon}}), organized by Merck and Accenture (8.07.2019 - 13.07.2019 in in Kronberg\textbackslash Darmstadt).
